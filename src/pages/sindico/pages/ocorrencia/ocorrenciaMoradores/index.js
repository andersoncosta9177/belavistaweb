  ...
  const fetchOcorrencias = async () => {
    try {
      ...
      const ocorrenciasRef = ref(
        db,
        "DadosBelaVista/DadosMoradores/ocorrencia"
      );
          ...
          async (uid) => {
            ...
            if (ocorrenciaData && ocorrenciaData.dataRegistro) {
              ...
              const comentariosRef = ref(
                db,
                `DadosBelaVista/DadosMoradores/ocorrencia/${uid}/${uid}/comentarios`
              );
              ...
              return {
                ...
                nomeMorador: ocorrenciaData.nomeMorador,
              };
            }
            return null;
          }
  ...
  const enviarComentario = async () => {
    ...
    try {
      ...
      const comentarioRef = ref(
        db,
        `DadosBelaVista/DadosMoradores/ocorrencia/${ocorrenciaSelecionada.id}/${ocorrenciaSelecionada.id}/comentarios/${timestamp}`
      );
  ...
  const handleMarcarComoLido = async (ocorrenciaId, uidMorador) => {
    try {
      ...
      const ocorrenciaRef = ref(
        db,
        `DadosBelaVista/DadosMoradores/ocorrencia/${ocorrenciaId}`
      );
                  ...
                  <>
                    ...
                    <View style={styles.content}>
                      ...
                      <View style={styles.infoRow}>
                        ...
                        />
                        <Text style={styles.infoText}>
                          Apartamento: {ocorrencia.apartamento || "N/I"}
                        </Text>
                      </View>
