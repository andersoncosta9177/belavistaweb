...
const DadosMorador = () => {
  ...
  useEffect(() => {
    ...
    const moradorRef = ref(db, `DadosBelaVista/usuarios/usuarioCondominio/${user.uid}`);
        ...
        <View style={styles.content}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.section}>
              ...
              <Input
                label="Cnpj"
                value={moradorData.cnpj}
                onChangeText={(text) => setMoradorData({ ...moradorData, cnpj: text })}
                disabled={!isEditing}
                errorMessage={errors.apartamento}
                inputStyle={styles.inputText}
                labelStyle={styles.label}
                inputContainerStyle={[styles.inputContainer, errors.cnpj && styles.inputError]}
                  leftIcon={<Icon name="office-building" type="material-community" size={20} color="#43e6f1" />}
